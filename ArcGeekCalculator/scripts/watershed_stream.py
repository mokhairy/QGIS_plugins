...
class WatershedAnalysisAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        try:
            ...
            # Fixed: Use a reasonable fixed threshold for r.watershed (in number of cells)
            # This is only for internal processing, not the user-configurable threshold
            watershed_threshold = 10000
            ...
            # Use the user-defined threshold here for stream extraction
    ...
    def shortHelpString(self):
        ...
        Parameters:
            Input DEM: A UTM raster layer representing the terrain elevation
            Flow Accumulation Threshold: Minimum number of cells to form a stream (controls stream network density)

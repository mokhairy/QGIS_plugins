...
class Ui_hcmgis_xls2csv_form(object):
    def setupUi(self, hcmgis_xls2csv_form):
        ...
        self.BtnApplyClose = QtWidgets.QDialogButtonBox(hcmgis_xls2csv_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_xls2csv_form.accept)
        self.BtnApplyClose.rejected.connect(hcmgis_xls2csv_form.reject)

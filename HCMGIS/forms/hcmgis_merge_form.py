...
class Ui_hcmgis_merge_form(object):
    def setupUi(self, hcmgis_merge_form):
        ...
        self.BtnApplyClose = QtWidgets.QDialogButtonBox(hcmgis_merge_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_merge_form.accept)
        self.BtnApplyClose.rejected.connect(hcmgis_merge_form.reject)

...
from qgis_plugin_templater_gui.toolbelt import PlgLogger, PlgOptionsManager
from qgis_plugin_templater_gui.toolbelt.preferences import PlgSettingsStructure
...
class ConfigOptionsPage(FORM_CLASS, QgsOptionsPageWidget):
    ...
    def apply(self):
        ...
        # Templater
        settings.template_url = self.template_url.text()
    ...
    def load_settings(self):
        ...
        # Templater
        self.template_url.setText(settings.template_url)

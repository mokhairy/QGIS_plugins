...
# package
import qgis_plugin_templater_gui.toolbelt.log_handler as log_hdlr
from qgis_plugin_templater_gui.__about__ import __title__, __version__
from qgis_plugin_templater_gui.toolbelt.env_var_parser import EnvVarParser

# ############################################################################
# ########## Classes ###############
# ##################################

PREFIX_ENV_VARIABLE = "QGIS_QGIS_PLUGIN_TEMPLATER_GUI_"
...
class PlgSettingsStructure:
    ...
    template_url: str = (
        ...
        "-/archive/master/template-qgis-plugin-master.zip"
    )

...
# project
from qgis_plugin_templater_gui.__about__ import __icon_path__, __title__, __version__
...
class QgisPluginTemplaterGuiProvider(QgsProcessingProvider):
    """Processing provider class."""

    def loadAlgorithms(self):
        """Loads all algorithms belonging to this provider."""
        self.addAlgorithm(RunQgisPluginTemplater())
    ...
    def id(self) -> str:
        ...
        :rtype: str
        """
        return "qgis_plugin_templater_gui"

...
class APCPlan:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/apc_plan_dev/icons/hou_pdo_red_padded_dev.svg'
        action = QAction(QIcon(icon_path), "APC Plan Dev", self.iface.mainWindow())
